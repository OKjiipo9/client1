...
// system client visuals
MACRO_CONFIG_INT(ClSysHammerHitFx, cl_sys_hammer_hit_fx, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable enhanced hammer hit effects (visual)")
MACRO_CONFIG_INT(ClSysHammerHitFxIntensity, cl_sys_hammer_hit_fx_intensity, 100, 0, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enhanced hammer hit effects intensity (0-200)")
MACRO_CONFIG_INT(ClSysHammerHitTrail, cl_sys_hammer_hit_trail, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable hammer hit trail particles (visual)")
MACRO_CONFIG_COL(ClSysHammerHitFxColor, cl_sys_hammer_hit_fx_color, 0x66CCFFFF, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enhanced hammer hit effects color (visual)")
MACRO_CONFIG_INT(ClSysHammerHitFxStyle, cl_sys_hammer_hit_fx_style, 0, 0, 5, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Hammer hit FX style (0=Impact, 1=Storm, 2=Nova, 3=Void, 4=Frost, 5=Inferno)")

MACRO_CONFIG_INT(ClSysBulletTrailFx, cl_sys_bullet_trail_fx, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable enhanced bullet trail effects (visual)")
MACRO_CONFIG_INT(ClSysBulletTrailFxIntensity, cl_sys_bullet_trail_fx_intensity, 100, 0, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enhanced bullet trail effects intensity (0-200)")
MACRO_CONFIG_COL(ClSysBulletTrailFxColor, cl_sys_bullet_trail_fx_color, 0xFFFFFFFF, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enhanced bullet trail effects color (visual)")

MACRO_CONFIG_INT(ClSysAirJumpFx, cl_sys_airjump_fx, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable enhanced air jump effects (visual)")
MACRO_CONFIG_INT(ClSysAirJumpFxIntensity, cl_sys_airjump_fx_intensity, 100, 0, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enhanced air jump effects intensity (0-200)")
MACRO_CONFIG_COL(ClSysAirJumpFxColor, cl_sys_airjump_fx_color, 0x66CCFFFF, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enhanced air jump effects color (visual)")
