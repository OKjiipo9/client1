...
#include "components/system_visuals.h"
#include "components/pclient_visuals.h"
...
public:
	...
	CSystemVisuals m_SystemVisuals;

	// System Client misc/visual component
	CWibeVisuals m_WibeVisuals;
...
private:
	...
	static void ConToggleSystemGui(IConsole::IResult *pResult, void *pUserData);
